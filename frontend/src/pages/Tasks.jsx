            ...
            <main className="flex-1 min-w-0 pt-20 px-4 md:px-8 lg:px-12 max-w-7xl mx-auto w-full pb-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <section className="glass-card p-6 md:p-8 h-fit sticky top-20">
                        <h2 className="text-lg font-bold text-zinc-100 mb-6">Create Task</h2>
                    ...
                    <section className="lg:col-span-2">
                        <h2 className="text-lg font-bold text-zinc-100 mb-6">Tasks List</h2>
                        {!form.startup_id ? (
                            <div className="flex flex-col items-center justify-center text-center p-12 bg-zinc-900/20 rounded-2xl border border-dashed border-zinc-800 text-zinc-500 text-sm">
                                <p className="mb-2">Select a startup</p>
                                <p>to view and create tasks</p>
                            </div>
                        ) : tasks.length === 0 ? (
                            <div className="flex flex-col items-center justify-center text-center p-12 bg-zinc-900/20 rounded-2xl border border-dashed border-zinc-800 text-zinc-500 text-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {tasks.map(task=>(
                                    <div key={task.id} className="glass-card p-6 md:p-8 hover:shadow-2xl flex flex-col">
                                        <div className="mb-4">
                                            <h3 className="text-lg md:text-xl font-bold text-zinc-100 mb-2">{task.title}</h3>
